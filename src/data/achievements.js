export const achievementsList = [
    ...
    { name: "Desastre Brutal", description: "Tire 1 ou menos no teste.", icon: "🥀", trigger: "roll", condition: { lte: 1 } },
    ...
    { name: "Leroy Jenkins", description: "Fracasse profundamente em uma cena furtiva.", icon: "🎖️", trigger: "manual" },
